...
function copyToClipboard(elementId, button, port) {
...
async function show(data) {
    ...
    document.getElementById('mcInfoDNS').previousElementSibling.style.display = 'none';
    document.getElementById('mcInfoDNS').nextElementSibling.style.display = '';
    document.getElementById('mcInfoIP').previousElementSibling.style.display = 'none';
    document.getElementById('mcInfoIP').nextElementSibling.style.display = '';
